...
class Values {
    ...
    var hitterPlayerMap = mutableMapOf<String, Player>(
        "한준수" to Player(id = 1, "한준수", PLAYER_TYPE_HITTER, "KIA", SUNGJIN_INSTAZ),
        ...
        "나승엽" to Player(id = 7, "나승엽", PLAYER_TYPE_HITTER, "롯데", JUHYUNG_DONGHEEMOMS),
        ...
        "박지환" to Player(id = 20, "박지환", PLAYER_TYPE_HITTER, "SSG", DAEHYUN_SPIDERS),
        ...
        "구본혁" to Player(id = 32, "구본혁", PLAYER_TYPE_HITTER, "LG", DONGYUN_MRS),
        ...
        "박승욱" to Player(id = 37, "박승욱", PLAYER_TYPE_HITTER, "롯데", TAEMIN_SHINEES),
        "노진혁" to Player(id = 38, "노진혁", PLAYER_TYPE_HITTER, "롯데", DONGJIN_UNIVERSE),
        "김휘집" to Player(id = 39, "김휘집", PLAYER_TYPE_HITTER, "NC", JUHYUNG_DONGHEEMOMS),
        ...
        "디아즈" to Player(id = 44, "디아즈", PLAYER_TYPE_HITTER, "삼성", DAEHYUN_SPIDERS),
        ...
        "제러드" to Player(id = 54, "제러드", PLAYER_TYPE_HITTER, "두산", DONGJIN_UNIVERSE),
    ...
    var pitcherPlayerMap = mutableMapOf<String, Player>(
        ...
        "헤이수스" to Player(id = 5, "헤이수스", PLAYER_TYPE_PITCHER, "키움", TAEMIN_SHINEES),
        ...
        "발라조빅" to Player(id = 11, "발라조빅", PLAYER_TYPE_PITCHER, "두산", YEJIN_PRINCESS),
        ...
        "박상원" to Player(id = 21, "박상원", PLAYER_TYPE_PITCHER, "한화", TAEMIN_SHINEES),
        "에르난데스" to Player(id = 22, "에르난데스", PLAYER_TYPE_PITCHER, "LG", DONGJIN_UNIVERSE),
        "박세웅" to Player(id = 23, "박세웅", PLAYER_TYPE_PITCHER, "롯데", JUHYUNG_DONGHEEMOMS),
        "오원석" to Player(id = 24, "오원석", PLAYER_TYPE_PITCHER, "SSG", DONGYUN_MRS),
        "신민혁" to Player(id = 25, "신민혁", PLAYER_TYPE_PITCHER, "NC", SUNGJIN_INSTAZ),
        "앤더슨" to Player(id = 26, "앤더슨", PLAYER_TYPE_PITCHER, "SSG", ISAAC_TOASTERZ),
        "이승현(좌)" to Player(id = 27, "이승현(좌)", PLAYER_TYPE_PITCHER, "삼성", YEJIN_PRINCESS),
        "하영민" to Player(id = 28, "하영민", PLAYER_TYPE_PITCHER, "키움", DAEHYUN_SPIDERS),
        ...
        "알드레드" to Player(id = 32, "알드레드", PLAYER_TYPE_PITCHER, "KIA", DONGYUN_MRS),
        ...
        "김진욱" to Player(id = 39, "김진욱", PLAYER_TYPE_PITCHER, "롯데", JUHYUNG_DONGHEEMOMS),
        "김민" to Player(id = 40, "김민", PLAYER_TYPE_PITCHER, "KT", DONGYUN_MRS),
        ...
        "이교훈" to Player(id = 43, "이교훈", PLAYER_TYPE_PITCHER, "두산", YEJIN_PRINCESS),
        ...
        "김성민" to Player(id = 46, "김성민", PLAYER_TYPE_PITCHER, "키움", DONGJIN_UNIVERSE),
        ...
        "최지강" to Player(id = 49, "최지강", PLAYER_TYPE_PITCHER, "두산", SUNGJIN_INSTAZ),
        ...
        "최지강" to Player(id = 57, "최지강", PLAYER_TYPE_PITCHER, "삼성", SUNGJIN_INSTAZ),
        ...
        "구승민" to Player(id = 63, "구승민", PLAYER_TYPE_PITCHER, "롯데", JUHYUNG_DONGHEEMOMS),
        "문승원" to Player(id = 64, "문승원", PLAYER_TYPE_PITCHER, "SSG", DONGYUN_MRS),
        "이병헌" to Player(id = 65, "이병헌", PLAYER_TYPE_PITCHER, "두산", SUNGJIN_INSTAZ),
        "주승우" to Player(id = 66, "주승우", PLAYER_TYPE_PITCHER, "키움", ISAAC_TOASTERZ),
        ...
        "황동하" to Player(id = 69, "황동하", PLAYER_TYPE_PITCHER, "KIA", TAEMIN_SHINEES),
        "홍건희" to Player(id = 70, "홍건희", PLAYER_TYPE_PITCHER, "두산", DONGJIN_UNIVERSE),
    ...
    var userTotalPointMap = mutableMapOf<Int, Double>(
        SUNGJIN_INSTAZ to 13055.20,
        ISAAC_TOASTERZ to 11278.93,
        YEJIN_PRINCESS to 8745.76,
        DAEHYUN_SPIDERS to 11552.38,
        TAEMIN_SHINEES to 13568.05,
        DONGJIN_UNIVERSE to 10765.83,
        JUHYUNG_DONGHEEMOMS to 15818.56,
        DONGYUN_MRS to 10874.15,
    )
